...
public:
    ...
    explicit TaxAmountTable(const QList<QSharedPointer<Shipment>> &shipments, const CurrencyRateManager *currencyRateManager, const QString &destCurrency, QObject *parent = nullptr);
    explicit TaxAmountTable(const QSharedPointer<QHash<QString, QHash<QString, QHash<TaxResolver::TaxContext, OrderManager::ShipmentRefundsWithUpdates>>>> &data, const CurrencyRateManager *currencyRateManager, const QString &destCurrency, QObject *parent = nullptr);
